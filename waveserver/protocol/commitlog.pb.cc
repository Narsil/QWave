...
::google::protobuf::Metadata ProtocolSubmitRequestList::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = ProtocolSubmitRequestList_descriptor_;
  metadata.reflection = ProtocolSubmitRequestList_reflection_;
  return metadata;
}
